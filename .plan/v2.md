...
- [ ] Prioritize the highest-value service, service-area, and blog content gaps based on commercial value and current site inventory
- [ ] Implement the first content-expansion slice on the most valuable pages/posts
- [ ] Re-verify changed pages and write a new handoff that reflects the post-intake, post-reconciliation reality
